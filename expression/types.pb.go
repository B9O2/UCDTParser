...
type SourceDataList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Sds []*SourceData `protobuf:"bytes,1,rep,name=sds,proto3" json:"sds,omitempty"`
}

func (x *SourceDataList) Reset() {
	*x = SourceDataList{}
	if protoimpl.UnsafeEnabled {
...
func (x *SourceDataList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SourceDataList) ProtoMessage() {}

func (x *SourceDataList) ProtoReflect() protoreflect.Message {
	mi := &file_expression_types_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SourceDataList.ProtoReflect.Descriptor instead.
func (*SourceDataList) Descriptor() ([]byte, []int) {
	return file_expression_types_proto_rawDescGZIP(), []int{1}
}

func (x *SourceDataList) GetSds() []*SourceData {
	if x != nil {
		return x.Sds
	}
	return nil
...
var file_expression_types_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x75, 0x63, 0x64, 0x74, 0x22, 0x75,
	0x0a, 0x0a, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12, 0x2e, 0x0a, 0x04,
	0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x75, 0x63, 0x64,
	0x74, 0x2e, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x44, 0x61, 0x74,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x34, 0x0a, 0x0e, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x44,
	0x61, 0x74, 0x61, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x22, 0x0a, 0x03, 0x73, 0x64, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x75, 0x63, 0x64, 0x74, 0x2e, 0x53, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x44, 0x61, 0x74, 0x61, 0x52, 0x03, 0x73, 0x64, 0x73, 0x42, 0x0e, 0x5a, 0x0c, 0x2e,
	0x2f, 0x65, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_expression_types_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_expression_types_proto_goTypes = []interface{}{
	(*SourceData)(nil),     // 0: ucdt.SourceData
	(*SourceDataList)(nil), // 1: ucdt.SourceDataList
...
var file_expression_types_proto_depIdxs = []int32{
	...
	0, // 1: ucdt.SourceDataList.sds:type_name -> ucdt.SourceData
...
func file_expression_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_expression_types_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SourceDataList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
